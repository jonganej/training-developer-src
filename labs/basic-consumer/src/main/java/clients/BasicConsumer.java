...
public class BasicConsumer {
    public static void main(String[] args) {
        ...
        // TODO: Add code here...Properties settings = new Properties();
        Properties settings = new Properties();
        settings.put(ConsumerConfig.GROUP_ID_CONFIG, "basic-consumer-2");
        ...
        try (KafkaConsumer<String, String> consumer = new KafkaConsumer<>(settings)) {
            consumer.subscribe(Arrays.asList("helloworld-topic"));
            consumer.poll(0);
